...
class TestYG_1(unittest.TestCase):

    """ 
    This class will perform unit testing on xplan2sbol conversion for yeastGates example.

    Notes: The destination and source URI does not end with a version in comparison to the rule of 30 example.
    
    1. Run module as a standalone: python -m unittest tests/Test_YG_1.py
